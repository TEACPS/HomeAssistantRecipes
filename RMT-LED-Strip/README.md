...
* Connect the Data pin of the strip to any GPIO of the ESP. For this tutorial we'll use GPIO 1
...
# interferes with IR transmitter!
  ...
  - platform: esp32_rmt_led_strip
    ...
    pin: GPIO1            # Use a safe data pin; some boards need to avoid GPIO0
