...
## Setup
The provided sensor is of type DHT12 which can be used via *OneWire* or *I2C* protocols. For the use in ESPHome, only *OneWire* is supported and the `model` configuration will be set to `DHT11`.
